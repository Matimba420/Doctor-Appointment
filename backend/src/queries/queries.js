...
const addAdmin="INSERT INTO PUBLIC.ADMIN (admin_name, admin_surname, cell_no, email, password) VALUES ($1, $2, $3, $4, $5)"
...
const getAdminPasswordByEmail="SELECT * FROM PUBLIC.ADMIN  WHERE email=$1"
const adminLogin = "SELECT id, admin_name, admin_surname, cell_no, email FROM PUBLIC.ADMIN  WHERE password=$1 AND email=$2";
...
const removeAppointment= "UPDATE APPOINTMENT SET is_available='false', user_id= null, pet_id=null WHERE id=$1"
